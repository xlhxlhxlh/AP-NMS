...
<body>
    <div class="wrapper">
        <h2>NMS后台管理系统</h2>
			<div class="add">
			   <a href="addapserver.html">增加参数</a>
			</div>
        <table id="customers">
            <tr>
			      <th>操作</th>
            ...
            <?php
                ...
                while($row = mysqli_fetch_array($result)){
					...
					echo "<td>".$row["id"]."</td><td>".$row["Apserver_IP"]."</td>";
    ...
    <script type="text/javascript">
       function del (id) {
           if (confirm("确定删除这个用户吗？")){
                window.location = "delapserer.php?id="+id;
           }
        }
		function edi(id){
			if (confirm("确定修改这个用户吗？")){
				window.location = "editapserver.php?id="+id;
			}
		}
    </script>
	<script type="text/javascript">
         window.setTimeout("window.location='apserver.php'",30000);
   </script>
</body>
</html>